...
public class QUESTION_14 {
	...
	public static void main(String[] args) {
		...
		String tops = "Tops Technologies!";
		
		System.out.println("The character at position 0 is "+tops.charAt(0));
		System.out.println("The character at position 10 is "+tops.charAt(10));
	}
